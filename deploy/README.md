...
| `DOCKER.md` | Docker/GHCR deployment documentation |
...
curl -sSL https://raw.githubusercontent.com/DoodleXu/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/DoodleXu/sub2api/releases)
