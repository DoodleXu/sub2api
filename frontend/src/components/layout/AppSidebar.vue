...
const flagWebConsole = makeSidebarFlag(FeatureFlags.webConsole)
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    { path: '/console', label: t('nav.webConsole'), icon: SparklesIcon, featureFlag: flagWebConsole },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/operations', label: t('nav.operationsCenter'), icon: OperationsIcon },
