...
describe('ProfileView', () => {
  ...
  it('renders the simplified single-column profile shell without separate stat cards', async () => {
    const wrapper = mount(ProfileView, {
      global: {
        stubs: {
          ...
          ProfileCheckinCalendarCard: { template: '<div data-testid="profile-checkin-calendar-card" />' },
    ...
    expect(wrapper.get('[data-testid="profile-shell"]').html()).toContain('profile-checkin-calendar-card')
