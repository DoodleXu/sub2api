...
const hasVisibleUsageColumn = computed(() => !authStore.isSimpleMode && isColumnVisible("usage"));
...
// 监听 subscription_type 变化，清理当前计费类型不支持的字段；标准模式清空高峰配置
watch(
...
watch(
  ...
  (newVal) => {
    ...
    applySubscriptionLimitPolicyToForm(editForm);
  },
);
