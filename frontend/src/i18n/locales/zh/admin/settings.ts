export default {
    settings: {
      ...
      payment: {
        ...
        rechargeGift: '充值满赠',
        rechargeGiftHint: '按充值金额门槛设置赠送比例，达到多个门槛时取最高赠送比例',
        rechargeGiftTiers: '满赠档位',
        rechargeGiftAddTier: '添加档位',
        rechargeGiftThreshold: '充值满额',
        rechargeGiftPercent: '赠送比例',
        rechargeGiftDelete: '删除',
        rechargeGiftEmpty: '暂无档位，添加档位后才会赠送',
        ...
        field_providerFeeRateHint: '该服务商独立手续费率，留空继承全局充值手续费率；填写 0 表示该服务商不收取手续费。',
      ...
      openaiExperimentalScheduler: {
        ...
        lowRatePriorityDescription: '开启后优先选择计费倍率较低的账号；不支持倍率探测的账号按每刀成本参与比较。数值相同时，再比较账号优先级和当前负载等。启用实验调度策略后，此开关不生效。',
        ...
        usdToCnyRateTitle: '调度美元兑人民币汇率',
        usdToCnyRateDescription: '将账号每刀人民币成本换算为与上游计费倍率相同的美元成本口径。填写 1 USD 对应的 CNY 数值，例如 7.2。',
