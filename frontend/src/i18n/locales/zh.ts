  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: '开启后，仅在请求显式选择 image_generation 或紧接生图续轮时注入 hosted 图片工具；普通文本请求不会注入。仅在路由账号支持图片生成时开启。',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageToolDesc:
          '统一控制 Codex /responses 的 image_generation 图片工具：仅在显式选择或紧接生图续轮时桥接，以及客户端自带该工具时是否放行。账号级策略优先于渠道和全局配置，不影响独立图片生成接口。',
        codexImageToolInherit: '跟随渠道',
        codexImageToolInheritDesc: '不写入账号覆盖，是否注入由渠道或全局策略决定；客户端自带的图片工具照常放行。',
        codexImageToolEnabled: '启用显式桥接',
        codexImageToolEnabledDesc: '仅在请求显式选择 image_generation 或紧接生图续轮时注入 hosted 图片工具。',
        ...
        codexImageToolBadgeEnabled: '显式桥接',
