export default {
  ...
  home: {
    ...
    getStarted: '立即开始',
    goToDashboard: '进入控制台',
    stableRunning: '本站已稳定运行{days}天{hours}小时{minutes}分{seconds}秒',
    // 新增：面向用户的价值主张
  ...
  nav: {
    ...
    imageGenerationQueue: '生图队列',
    imageGenerationResults: '生图结果',
    redeem: '兑换',
    affiliate: '邀请返利',
  ...
  affiliate: {
    title: '邀请返利',
    description: '邀请新用户注册，充值产生返利；订阅不产生返利',
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
    ...
    tips: {
      ...
      line2: '仅被邀请用户充值后，你可获得 {rate} 的返利额度；订阅不产生返利。',
      line3: '返利额度可随时转入账户余额。',
  ...
  profile: {
    ...
    checkin: {
      calendarTitle: '本月签到',
      calendarDescription: '每天消费达到要求后可签到领取随机额度。',
      checkedDays: '已签到天数',
      todayUsage: '今日消费',
      requiredUsage: '签到要求',
      rewardRange: '奖励范围',
      success: '签到成功，已获得 {amount} 额度',
      successStreak: '已连续签到 {days} 天，今日奖励为 {multiplier}，已获得 {amount} 额度',
      successCritSimple: '幸运暴击！今日奖励暴击 {critMultiplier}，已获得 {amount} 额度',
      successCrit: '幸运暴击！已连续签到 {days} 天，连签 {streakMultiplier}，暴击 {critMultiplier}，已获得 {amount} 额度',
      failed: '签到失败',
      loadFailed: '加载签到状态失败',
      alreadyCheckedIn: '今天已经签到',
      disabled: '签到活动暂未开启',
      budgetExhausted: '签到奖励额度已发完，请稍后再试',
      tooManyRequests: '请求过于频繁，请稍后再试',
      usageNotEnough: '今日消费 {current}，至少达到 {required} 后才可签到',
      readyTitle: '今日可签到，随机奖励 {min}-{max} 美元额度',
      needUsageTitle: '今日消费 {current}，达到 {required} 后可签到',
      checkedDayLabel: '{date} 已签到',
      uncheckedDayLabel: '{date} 未签到',
      weekdays: {
        mon: '一',
        tue: '二',
        wed: '三',
  ...
  admin: {
    imageGenerations: {
      ...
      asyncBucket: '上游异步生图桶',
      viewPrefix: '查看前缀',
      noObjects: '当前前缀下没有异步生图结果',
      loadObjectsFailed: '读取异步生图对象失败，请检查 ListBucket 权限。',
      queueEyebrow: '异步任务监控',
      queueTitle: '生图队列',
      queueDescription: '实时查看异步生图任务的处理状态、耗时和停止原因。',
      autoRefresh: '自动刷新',
    ...
    dashboard: {
      ...
      averageCost: '平均成本',
      perUsd: '每美元',
      anthropicAverageCost: 'Anthropic 平均成本',
    ...
    audit: {
      ...
      loadFailed: '加载操作日志失败',
      filters: {
        all: '全部', q: '关键字', qPlaceholder: '路径 / 动作 / 操作者邮箱', actorEmail: '操作者邮箱',
        action: '动作', clientIp: '客户端 IP', method: '请求方法', authMethod: '认证方式', result: '结果',
        resultSuccess: '成功', resultFailure: '失败', startTime: '开始时间', endTime: '结束时间'
      },
      authMethods: { password: '密码', passwordTotp: '密码 + TOTP', oauthTotp: 'OAuth + TOTP' },
      columns: { time: '时间', actor: '操作者', action: '动作', method: '方法', result: '结果', clientIp: '客户端 IP', detail: '详情' },
      detail: {
        title: '操作日志详情', actorRole: '角色', methodPath: '方法 / 路径', latency: '耗时', requestId: '请求 ID',
        credential: '凭证（掩码）', userAgent: 'User-Agent', requestBody: '请求体（已脱敏）', extra: '附加信息'
      },
      clearConfirm: {
        title: '清理全部操作日志',
        message: '此操作将永久删除所有操作日志，且不可恢复。清理动作本身会被留痕记录。确定继续吗？',
        totpTitle: '输入二次验证码', totpHint: '清理操作日志需要现场验证 TOTP 验证码。',
        success: '已清理 {count} 条操作日志', failed: '清理操作日志失败'
      }
    },
    ...
    backup: {
      ...
      coreData: {
        title: '核心数据兼容导入',
        description: '用于新实例迁移旧站的核心运行数据，不执行全量 SQL 恢复。',
        scopeHint: '导入范围：账号、账号凭证、账号附加配置、代理节点，以及账号与代理的关联。不会导入用户、分组、订单、日志、统计、系统设置或备份记录。',
        warning: '导入会创建新账号；代理会按协议、地址、端口、用户名和密码复用。建议在新实例初始化后先导入，再手动检查账号分组和调度状态。',
        exportButton: '导出核心数据',
        exportSuccess: '核心数据文件已导出',
        exportFailed: '核心数据导出失败',
        fileLabel: '核心数据 JSON 文件',
        noFile: '请选择核心数据 JSON 文件',
        importButton: '导入核心数据',
        importing: '导入中...',
        parseFailed: 'JSON 文件解析失败',
        importFailed: '核心数据导入失败',
        importSuccess: '导入完成：账号 {account_created} 个，代理新建 {proxy_created} 个，代理复用 {proxy_reused} 个。',
        importCompletedWithErrors: '导入完成但存在失败：账号失败 {account_failed} 个，代理失败 {proxy_failed} 个。',
        resultTitle: '导入结果',
        resultSummary: '账号新建 {account_created} 个，账号失败 {account_failed} 个；代理新建 {proxy_created} 个，代理复用 {proxy_reused} 个，代理失败 {proxy_failed} 个。'
      },
      columns: {
        status: '状态',
        fileName: '文件名',
    ...
    groups: {
      ...
      subscription: {
        ...
        standard: '标准（余额）',
        subscription: '订阅（月配额）',
        subscriptionMonthly: '订阅（月配额）',
        subscriptionWeekly: '订阅（周配额）',
        subscriptionDaily: '订阅（日配额）',
        dailyLimit: '每日限额（USD）',
    ...
    riskControl: {
      ...
      allowedHashCount: 'Hash 白名单数量：{count} 个',
      allowedHashHint: 'Hash 白名单持久化保存在数据库中，Redis 仅作为缓存；命中白名单会跳过关键词、历史风险 hash 和上游审核，并记录为放行日志。',
      allowedHashPlaceholder: '粘贴要加白的 64 位输入哈希',
      allowedHashNotePlaceholder: '备注（可选）',
      allowedHashSearchPlaceholder: '搜索白名单 Hash',
      allowHash: '加入白名单',
      allowHashShort: '加白',
      deleteAllowedHash: '移出白名单',
      clearAllowedHashes: '清空白名单',
      clearAllowedHashesConfirm: '确定要清空全部 Hash 白名单吗？此操作不会删除审核记录，但会取消所有 Hash 放行规则。',
      allowedHashAdded: 'Hash 已加入白名单',
      allowedHashAlreadyExists: '该 Hash 已在白名单中',
      allowedHashAddFailed: '加入 Hash 白名单失败',
      allowedHashDeleted: 'Hash 已移出白名单',
      allowedHashNotFound: '该白名单 Hash 不存在',
      allowedHashDeleteFailed: '移出 Hash 白名单失败',
      allowedHashListFailed: '加载 Hash 白名单失败',
      allowedHashesCleared: '已清空 {count} 个白名单 Hash',
      allowedHashesClearFailed: '清空 Hash 白名单失败',
      allowedHashEmpty: '暂无 Hash 白名单',
      allowedHashColumns: {
        hash: 'Hash',
        source: '来源',
        note: '备注/摘要',
      ...
      autoBanned: '已封禁',
	      ...
	      userPolicy: {
	        title: '用户处置策略',
	        hint: '为个别用户覆盖命中后的拦截、错误码、通知和封号动作。白名单用户不会触发这些策略。',
	        search: '搜索 UID、邮箱或备注',
	        create: '新增策略',
	        createTitle: '新增用户处置策略',
	        editTitle: '编辑用户处置策略',
	        empty: '暂无用户处置策略',
	        loadFailed: '加载用户处置策略失败',
	        saved: '用户处置策略已保存',
	        saveFailed: '保存用户处置策略失败',
	        deleted: '用户处置策略已删除',
	        deleteFailed: '删除用户处置策略失败',
	        deleteConfirm: '确定要删除这个用户处置策略吗？',
	        enabled: '启用',
	        disabled: '停用',
	        inheritGlobal: '继承全局',
	        thresholdSummary: '{hours} 小时内 {count} 次封号',
	        columns: {
	          user: '用户',
	          action: '处置方式',
	          response: '返回',
	        ...
	        actions: {
	          blockOnly: '仅拦截',
	          blockNotify: '拦截并通知',
	          blockNotifyDisable: '拦截通知并封号',
	        },
	        form: {
	          user: '目标用户',
	          userSearch: '搜索用户名、邮箱或备注选择用户',
	          noUsers: '没有可添加用户',
	          action: '处置方式',
	          enabled: '启用策略',
	          enabledHint: '关闭后保留配置但不参与命中处置。',
	          blockStatus: 'HTTP 状态码（0 继承全局）',
	          errorCode: '返回错误码',
	          blockMessage: '拦截提示',
	          inheritMessage: '留空继承全局提示',
	          applyToHashBlock: '作用于哈希拦截',
	          applyToHashBlockHint: '默认只记录哈希快速拦截；开启后也会执行该用户策略副作用。',
	          note: '备注',
	        },
	      },
	      inputDetailTitle: '输入详情',
      inputDetailFullTitle: '输入完整内容详情',
      inputDetailContent: '用户输入内容',
      inputDetailSummaryContent: '摘要内容',
      matchedKeyword: '关键词：{keyword}',
      queueDelay: '排队 {ms} ms',
      allGroups: '全部分组',
      ...
      noGroups: '暂无可用分组',
      userWhitelist: '用户白名单',
      userWhitelistHint: '白名单用户的网关请求不会进入内容审计、关键词拦截、哈希拦截或自动封禁统计。',
      userWhitelistSearch: '搜索用户名、邮箱或备注添加白名单用户',
      userWhitelistNoResults: '没有匹配用户',
      userWhitelistCount: '已白名单 {count} 个 UID',
      forcedWhitelist: '强制保留',
      removeWhitelistUser: '移出白名单',
      modelFilter: '模型范围',
    ...
    subscriptions: {
      ...
      resetWeeklyQuota: '重置周配额',
      resetWeeklyQuotaTitle: '重置周用量配额',
      resetWeeklyQuotaConfirm: "确定要重置 '{user}' 的每日和每周用量配额吗？每月用量不会被重置。",
      weeklyQuotaResetSuccess: '周配额重置成功',
      failedToResetWeeklyQuota: '重置周配额失败',
      resetAllWeeklyQuota: '重置所有周配额',
      resetAllWeeklyQuotaTitle: '重置所有订阅周配额',
      resetAllWeeklyQuotaConfirm: '确定要重置所有有效订阅的每日和每周用量配额吗？每月用量不会被重置。',
      resetAllWeeklyQuotaDryRunSummary: 'Dry-run 预览：将影响 {count} 个有效订阅',
      allWeeklyQuotaResetSuccess: '已重置 {count} 个订阅的周配额，失败 {failed} 个，批次 {runId}',
      failedToPreviewResetAllWeeklyQuota: '预览重置所有周配额失败',
      failedToResetAllWeeklyQuota: '重置所有周配额失败',
    ...
    accounts: {
      ...
      listPendingSyncFailed: '自动同步列表失败，请稍后重试',
      ...
      bulkArchiveConfirm: '确定要归档选中的 {count} 个账号吗？历史成本和用量会保留。',
      bulkArchiveSuccess: '已归档 {count} 个账号',
      bulkEdit: {
        title: '批量编辑账号',
      ...
      totalCostCny: '账号成本',
      totalCostCnyHint: '输入本账号的购入成本以计算每美元的人民币成本',
      addCostCny: '增加人民币成本',
      addCostCnyHint: 'API Key 账号可填写本次新增成本，保存后会累加到累计成本',
      expiresAt: '过期时间',
    ...
    operations: {
      title: '运营中心',
      description: '管理签到活动、奖励规则与运营数据',
      overview: '概览',
      businessInsights: '经营分析',
      checkinAnalysis: '签到分析',
      records: '签到记录',
      rules: '奖励规则',
      last7Days: '近 7 天',
      last30Days: '近 30 天',
      ...
      last370Days: '近 370 天',
      applyRange: '应用日期',
      customDateFrom: '自定义开始日期',
      customDateTo: '自定义结束日期',
      invalidDateRange: '请选择有效的开始和结束日期',
      apiDau: 'API 日活',
      apiDauHint: '当前范围最后一天有 API 用量的去重用户',
      newUsers: '新增用户',
      requestUsers: '请求用户',
      requests: '请求量',
      actualCost: '实际消耗',
      activitySummary: '活跃摘要',
      apiActivityTrend: 'API 活跃趋势',
      apiActivityTrendHint: '按自然日统计 API 日活和新增用户，用于判断真实使用增长。',
      checkinTrend: '签到趋势',
      checkinTrendHint: '柱状显示签到人数，折线显示达标用户转化为签到的比例。',
      noTrendData: '暂无趋势数据',
      qualifiedUsers: '达标用户',
      checkinUsers: '签到用户',
      streakUsers: '连签用户',
      ...
      critRate: '暴击率',
      streakUserRate: '连签占比',
      projectedBudgetDays: '预算预计可用',
      daysValue: '{count} 天',
      checkinsValue: '约 {count} 人次',
      estimatedRemainingCheckins: '今日预计还可发放',
      unlimited: '不限',
      dataAsOf: '数据截至',
      reportingTimezone: '统计时区',
      dataCoverage: '数据覆盖',
      dataQuality: {
        complete: '数据完整',
        partial: '请求范围早于原始用量覆盖，结果可能不完整',
        empty: '当前范围暂无用量数据',
        unknown: '暂时无法确认数据覆盖范围',
      },
      vsPreviousPeriod: '较上一周期 {value}',
      noChange: '较上一周期持平',
      newFromZero: '上一周期为 0',
      exportData: '数据导出',
      exportOverview: '导出活跃日报',
      exportOverviewHint: '导出当前日期范围内的 DAU、新增用户、请求量和实际消耗。',
      exportSummary: '导出签到汇总',
      exportRecords: '导出明细',
      exporting: '导出中...',
      exportSuccess: '运营数据已导出',
      ...
      monthlyRemaining: '月预算剩余',
      refresh: '刷新',
      save: '保存规则',
      saving: '保存中...',
      saved: '签到规则已保存',
      loadFailed: '加载运营数据失败',
      overviewLoadFailed: '加载运营概览失败，当前显示的数据可能不是最新值',
      analyticsLoadFailed: '加载签到分析失败，当前显示的数据可能不是最新值',
      recordsLoadFailed: '加载签到记录失败',
      businessLoadFailed: '加载经营分析失败，当前显示的数据可能不是最新值',
      businessDataUnavailable: '所选区间的预聚合尚未覆盖，暂不计算扣费、成本和贡献毛利。',
      businessDataPartial: '当前区间包含仍在聚合的数据，经营指标展示截至最近已完成的聚合时间。',
      groupDetailsRangeLimited: '分组明细仅支持 31 天以内的区间',
      saveFailed: '保存签到规则失败',
      filters: '筛选',
      userSearch: '用户 ID / 邮箱 / 用户名',
      dateFrom: '开始日期',
      dateTo: '结束日期',
      rewardMin: '最低奖励',
      rewardMax: '最高奖励',
      ...
      critOnly: '仅暴击',
      nonCritOnly: '未暴击',
      minStreakDays: '最少连签天数',
      user: '用户',
      date: '日期',
      finalReward: '最终奖励',
      baseReward: '基础奖励',
      streakMultiplier: '连签倍数',
      critMultiplier: '暴击倍数',
      usage: '签到消费快照',
      createdAt: '创建时间',
      noRecords: '暂无签到记录',
      ...
      nextPage: '下一页',
      checkinEnabled: '启用签到',
      requiredUsage: '签到消费门槛',
      usageScope: '消费统计范围',
      usageScopeActual: '全部实际消费',
      usageScopeBalance: '仅余额消费',
      userMonthlyLimit: '用户月发放上限',
      dailyBudget: '每日总预算',
      monthlyBudget: '每月总预算',
      budgetFallbackReward: '预算用完保底奖励',
      budgetFallbackMessage: '预算用完提示文案',
      budgetFallbackHint: '当每日总预算不足以发放正常最小奖励时，继续允许签到并发放该固定保底奖励。',
      rewardTiers: '奖励概率档位',
      addTier: '添加档位',
      minReward: '最小奖励',
      maxReward: '最大奖励',
      ...
      streakEnabled: '启用连签倍数',
      streakScope: '连签周期',
      streakCrossMonth: '跨月连续',
      streakMonthly: '按月重置',
      streakRules: '连签倍数',
      addStreakRule: '添加倍数',
      days: '天数',
      ...
      critMaxRewardHint: '连签后奖励大于该金额时不参与暴击；0 表示不限制。',
      delete: '删除',
      totalUsers: '累计用户',
      todayNewUsers: '今日新增',
      todayActiveUsers: '今日活跃',
      periodRequestUsers: '区间请求用户',
      d1Retention: 'D1 API 留存',
      d7Retention: 'D7 API 留存',
      d30Retention: 'D30 API 留存',
      averageActiveDays: '人均活跃天数',
      revenueAndMargin: '收入与贡献毛利',
      paymentRevenue: '在线支付收入',
      adminRechargeRevenue: '管理员手动充值金额',
      adminRechargeCredits: '管理员手动增加余额',
      totalRevenue: '总收入',
      paidOrders: '支付订单',
      actualCharges: '实际扣费',
      upstreamCost: '上游账号成本',
      accountCostUsdBasis: '账号计费成本',
      rewardCost: '签到奖励成本',
      contributionMargin: '贡献毛利 / 毛利率',
      marginDefinition: '在线支付收入按 ISO 币种分别展示；管理员手动增加余额、实际扣费、账号计费成本、签到奖励和贡献毛利均为 USD 余额单位。真实人民币上游成本单独展示，不参与 USD 毛利计算。',
      productUsage: '产品使用',
      periodRequests: '区间请求量',
      periodTokens: '区间 Token',
      averageChargePerUser: '请求用户平均扣费',
      topModels: '模型贡献排行（请求量 / 实际扣费）',
      topGroups: '分组贡献排行（请求量 / 实际扣费）',
      noBusinessData: '暂无经营数据',
    },
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreDisabledApiKeyErrors: '忽略已禁用的 Key 报错',
        ignoreDisabledApiKeyErrorsHint: '启用后，已禁用 API Key 的错误（API_KEY_DISABLED）将不会写入错误日志。',
    ...
    settings: {
      ...
      features: {
        ...
        webConsole: {
          ...
          defaultEndpointHint: '用户进入创作台时默认选中的端点，仍可在页面内手动切换。',
          primaryEndpoint: '主端点',
          currentEndpoint: '当前保存值 - {endpoint}',
        },
        dailyCheckin: {
          title: '签到',
          description: '用户达到配置的当日消费门槛后，可领取随机整数美元额度。',
          enabled: '启用签到',
          enabledHint: '关闭后用户侧签到按钮和个人页月历会隐藏，后端签到接口拒绝发放奖励。',
          todayCheckins: '今日签到',
          todayReward: '今日发放',
          monthReward: '本月发放',
          averageReward: '平均奖励',
          requiredUsage: '消费门槛（USD）',
          usageScope: '有效消费口径',
          usageScopeActualCost: '全部实际消费',
          usageScopeBalanceOnly: '仅余额消费',
          rewardMin: '单次最低奖励（USD）',
          rewardMax: '单次最高奖励（USD）',
          dailyBudget: '每日总预算（USD）',
          monthlyBudget: '每月总预算（USD）',
          userMonthlyLimit: '单用户月上限（USD）',
          dailyRemaining: '每日预算/剩余',
          monthlyRemaining: '每月预算/剩余',
          monthUsers: '本月参与用户',
          unlimited: '不限',
          statsLoadFailed: '签到统计加载失败，刷新成功前不会显示数值。',
          rewardHint: '0 表示不限制。签到奖励会直接发放到账户余额，单次最高 100 USD；最高值小于最低值时会自动按最低值保存。',
        },
        riskControl: {
          title: '风控中心',
      ...
      gatewayForwarding: {
        ...
        claudeOAuthSystemPromptBlocksPlaceholder: '留空时使用内置 3 个 blocks。支持数组或带 blocks 字段的对象。',
      ...
      site: {
        ...
        siteLaunchAt: '稳定运行起始时间',
        siteLaunchAtHint: '用于首页展示“本站已稳定运行”时间，留空则不展示。保存时会转换为带时区的绝对时间。',
      ...
      payment: {
        ...
        field_stripeFeeRateHint: '两个独立手续费字段都留空则继承全局充值手续费；如需覆盖 Stripe 手续费，手续费率和最低手续费必须同时填写。',
        field_stripeFeeMinHint: '两个独立手续费字段都留空则继承全局充值手续费；覆盖 Stripe 手续费时，最低手续费会加到金额 * 手续费率上。',
      ...
      notifications: {
        title: '全局通知',
        description: '通过邮件、Bark 和 Telegram Bot 发送渠道监控故障与恢复通知。',
        email: '邮件',
        emailHint: '复用可编辑的通知邮件模板。',
        bark: 'Bark',
        barkHint: '通过 Bark 向 iOS/macOS 客户端推送通知。',
        telegram: 'Telegram Bot',
        telegramHint: '通过 Telegram Bot API 发送消息。',
        recipients: '邮件收件人',
        recipientsPlaceholder: "admin{'@'}example.com\nops{'@'}example.com",
        barkServerUrl: 'Bark 服务地址',
        barkDeviceKeys: 'Bark Device Key',
        barkDeviceKeysPlaceholder: '每行一个 Device Key',
        barkLevel: 'Bark 通知级别',
        barkTitleTemplate: 'Bark 推送标题',
        barkTitleTemplatePlaceholder: 'Sub2API 渠道监控：{monitor_name} {new_status}',
        barkBodyTemplate: 'Bark 中文推送文案',
        barkBodyTemplatePlaceholder: '监控：{monitor_name}\n模型：{model}\n状态：{old_status} -> {new_status}',
        barkTemplateHint: '支持 {monitor_name}、{provider}、{group_name}、{model}、{old_status}、{new_status}、{latency_ms}、{message}、{triggered_at} 等变量。',
        telegramBotToken: 'Bot Token',
        telegramBotTokenHint: '从 BotFather 创建，后端会加密保存。',
        telegramChatIds: 'Chat ID',
        telegramChatIdsPlaceholder: '每行一个 Chat ID',
        onePerLineHint: '每行一个，也支持逗号分隔。',
        secretConfiguredPlaceholder: '已配置，留空以保留当前值。',
        secretConfiguredHint: '已有密钥配置，留空保存不会修改。',
        clearBarkDeviceKeys: '清空已保存的 Bark Device Key',
        clearTelegramBotToken: '清空已保存的 Bot Token',
        quietHours: '夜间免打扰',
        quietHoursHint: '命中时段内邮件、Bark 和 Telegram 通知会直接静默，不会在结束后补发。',
        ...
        saving: '保存中...',
        saved: '通知设置已保存',
        loadFailed: '通知设置加载失败。请刷新后再保存，避免覆盖已有配置。',
        saveFailed: '通知设置保存失败',
        testTransport: '测试已保存的 {transport}',
        testSavedHint: '请先保存通知设置再测试。测试会使用后端已保存的配置。',
        testSuccess: '测试通知已发送',
        testFailed: '测试通知发送失败',
        transports: {
          email: '邮件',
      ...
      emailBroadcast: {
        title: '邮件通知群发',
        pageDescription: '发起群发邮件，并管理后台发送任务的状态、停止、续发和失败补发。',
        composeTitle: '新建群发',
        description: '向选定用户范围发送重要邮件通知。正文使用“管理员邮件通知”模板包裹，并按低 RPM 后台发送。',
        taskTitle: '群发任务',
        taskDescription: '查看发送进度，停止运行任务，继续中断任务，或只补发失败收件人。',
        task: '任务',
        progress: '进度',
        startedAt: '开始时间',
        updatedAt: '更新时间',
        refreshTasks: '刷新任务',
        noTasks: '暂无邮件群发任务。',
        activeBatch: '运行中批次：{batch}',
        scope: '用户范围',
        locale: '邮件语言',
        rpm: '发送 RPM',
        rateHint: '约每 {seconds} 秒发送 1 封',
        messageTitle: '通知标题',
        messageTitlePlaceholder: '例如：服务维护通知',
        messageHtml: '通知正文 HTML',
        messageHtmlPlaceholder: '<p>请输入要发送给用户的通知内容。</p>',
        actionLabel: '按钮文案（可选）',
        actionLabelPlaceholder: '查看详情',
        actionUrl: '按钮链接（可选）',
        customUserIds: '指定用户 ID',
        customUserIdsPlaceholder: '每行一个用户 ID，也支持逗号分隔',
        customEmails: '额外邮箱',
        ...
        clearDraft: '清空草稿',
        draftSaved: '群发草稿已保存',
        draftCleared: '群发草稿已清空',
        draftLoadFailed: '群发草稿加载失败',
        draftSaveFailed: '群发草稿保存失败',
        draftClearFailed: '群发草稿清空失败',
        send: '开始群发',
        sending: '提交中...',
        required: '请填写通知标题和正文。',
        customRequired: '自定义范围需要至少填写一个用户 ID 或邮箱。',
        started: '邮件通知群发已开始：{count} 个收件人，批次 {batch}',
        failed: '邮件通知群发提交失败',
        statusFailed: '邮件通知群发状态刷新失败',
        operationFailed: '邮件群发任务操作失败',
        cancel: '停止',
        cancelRequested: '已请求停止任务',
        resume: '继续',
        resendFailed: '补发失败',
        resendUncertain: '重试未知投递',
        details: '明细',
        recipientDetails: '收件人明细（共 {count} 条）',
        recipientLoadFailed: '收件人明细加载失败',
        preflightFailed: '发送预检失败',
        resumed: '邮件群发任务已继续：{count} 个收件人，批次 {batch}',
        lastResult: '批次 {batch} 已开始，目标 {count} 人，RPM {rpm}，预计约 {seconds} 秒。',
        statusSummary: '状态：{status}，已发送 {sent}/{total}，跳过 {skipped}（退订 {unsubscribed}），失败 {failed}，未知 {uncertain}',
        confirmTitle: '确认发送邮件通知',
        confirmMessage: '此操作会立即开始真实邮件群发，请确认范围和速率无误。',
        confirmSummary: '发送范围：{scope}；RPM：{rpm}；约每 {seconds} 秒 1 封。',
        confirmPreflightSummary: '发送范围：{scope}；有效 {valid} 人，退订 {unsubscribed} 人，无效 {invalid} 人；RPM {rpm}；预计 {duration}。',
        durationSeconds: '{count} 秒',
        durationMinutes: '约 {count} 分钟',
        durationHours: '约 {count} 小时',
        confirmSend: '确认发送',
        confirmPhraseLabel: '批量范围需要输入 SEND 后才能发送',
        confirmPhraseRequired: '请输入 {phrase} 后再确认发送。',
        scopes: {
          activeUsers: '活跃普通用户',
          allUsers: '全部普通用户',
          admins: '活跃管理员',
  ...
  payment: {
    ...
    upgrade: {
      ...
      noEligibleSubscriptions: '当前没有可折抵订阅。仅同一平台内、仍在有效期内且来自有效付费订单的订阅可用于折抵。',
      noEligibleSubscriptionsWithActive: '当前活跃订阅暂不可折抵。请确认旧订阅与新套餐属于同一平台，并且旧订阅来自有效付费订单。',
      retry: '重试',
    ...
    admin: {
      ...
      deductSubscription: '取消已生效的订阅权益',
      deductSubscriptionHint: '从用户当前订阅中扣减对应有效期',
      subscriptionDaysToDeduct: '扣除天数',
      subscriptionDaysAutoHint: '按当前退款金额建议扣除 {days} 天，可手动调整',
      subscriptionRemainingHint: '按当前订阅剩余 {days} 天折算退款金额，可手动调整',
      noSubscriptionDeduction: '将不扣减用户订阅权益',
      userBalance: '用户余额',
      orderAmount: '订单金额',
