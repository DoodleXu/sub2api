export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      setPrivacy: '设置隐私',
      inviteReset: '官方额度重置',
      inviteResetTitle: 'Codex 官方额度重置',
      inviteResetSubtitle: '查询并使用 OpenAI 官方 Codex 邀请重置机会，不会修改 sub2api 本地用户或订阅额度。',
      inviteResetRefresh: '刷新状态',
      inviteResetAvailable: '可用重置机会',
      inviteResetAvailableUnit: '次',
      inviteResetSelectedCredit: '选择重置机会',
      inviteResetSelectCredit: '请选择可用机会',
      inviteResetNoCredits: '暂无可用官方重置机会。可以先发送邀请，等官方发放后再刷新。',
      inviteResetUseReset: '使用官方重置',
      inviteResetUsing: '正在使用...',
      inviteResetRules: '官方资格规则',
      inviteResetRulesEmpty: '官方接口未返回规则。',
      inviteResetInviteEmails: '邀请邮箱',
      inviteResetPlaceholder: 'user@example.com\nfriend@example.com',
      inviteResetEmailHint: '一次最多邀请 {max} 个邮箱，可用逗号、空格或换行分隔。',
      inviteResetConsent: '我确认这些邮箱同意接收 OpenAI Codex 邀请邮件。',
      inviteResetSendInvite: '发送邀请',
      inviteResetSending: '发送中...',
      inviteResetCreditFallbackTitle: '官方重置机会',
      inviteResetCreditFallbackDescription: '可用于重置该 OpenAI OAuth 账号的 Codex 官方额度。',
      inviteResetEmailsRequired: '请输入至少一个邮箱',
      inviteResetEmailLimit: '一次最多邀请 {max} 个邮箱',
      inviteResetInvalidEmail: '邮箱格式无效：{email}',
      inviteResetConsentRequired: '请先确认邀请邮箱已同意接收邮件',
      inviteResetLoadFailed: '加载官方重置状态失败',
      inviteResetInviteSuccess: '邀请已发送',
      inviteResetInviteFailed: '发送邀请失败',
      inviteResetInvitePartialFailed: '部分邮箱发送失败：{emails}',
      inviteResetConsumeSuccess: '官方额度重置成功',
      inviteResetConsumeFailed: '使用官方重置失败',
      inviteResetNothingToReset: '官方返回无需重置',
      inviteResetAlreadyRedeemed: '该重置机会已使用',
      inviteResetNoCredit: '没有可用重置机会',
      ...
      openai: {
        ...
        codexInviteResetSettings: 'Codex 官方额度重置请求',
        codexInviteResetSettingsDesc: '仅影响此 OpenAI OAuth 账号的官方额度重置状态、邀请和使用重置次数请求。',
        codexInviteResetUserAgent: '重置请求 User-Agent',
