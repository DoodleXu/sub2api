export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      inviteReset: 'Official Quota Reset',
      inviteResetTitle: 'Codex Official Quota Reset',
      inviteResetSubtitle: 'Query and use OpenAI official Codex invite reset credits. This does not change local sub2api user or subscription quota.',
      inviteResetRefresh: 'Refresh Status',
      inviteResetAvailable: 'Available Reset Credits',
      inviteResetAvailableUnit: 'credits',
      inviteResetSelectedCredit: 'Selected Credit',
      inviteResetSelectCredit: 'Select an available credit',
      inviteResetNoCredits: 'No official reset credits are available. Send invites first, then refresh after OpenAI grants credits.',
      inviteResetUseReset: 'Use Official Reset',
      inviteResetUsing: 'Using...',
      inviteResetRules: 'Official Eligibility Rules',
      inviteResetRulesEmpty: 'No rules were returned by the official API.',
      inviteResetInviteEmails: 'Invite Emails',
      inviteResetPlaceholder: 'user@example.com\nfriend@example.com',
      inviteResetEmailHint: 'Invite up to {max} emails at once. Separate with commas, spaces, or new lines.',
      inviteResetConsent: 'I confirm these email recipients consent to receive OpenAI Codex invitation emails.',
      inviteResetSendInvite: 'Send Invite',
      inviteResetSending: 'Sending...',
      inviteResetCreditFallbackTitle: 'Official Reset Credit',
      inviteResetCreditFallbackDescription: 'Can be used to reset this OpenAI OAuth account\'s official Codex quota.',
      inviteResetEmailsRequired: 'Enter at least one email',
      inviteResetEmailLimit: 'You can invite at most {max} emails at once',
      inviteResetInvalidEmail: 'Invalid email: {email}',
      inviteResetConsentRequired: 'Confirm the invite recipients consent to receive email first',
      inviteResetLoadFailed: 'Failed to load official reset status',
      inviteResetInviteSuccess: 'Invite sent',
      inviteResetInviteFailed: 'Failed to send invite',
      inviteResetInvitePartialFailed: 'Some emails failed: {emails}',
      inviteResetConsumeSuccess: 'Official quota reset succeeded',
      inviteResetConsumeFailed: 'Failed to use official reset',
      inviteResetNothingToReset: 'Official API says there is nothing to reset',
      inviteResetAlreadyRedeemed: 'This reset credit was already redeemed',
      ...
      openai: {
        ...
        codexInviteResetSettings: 'Codex official quota reset requests',
        codexInviteResetSettingsDesc:
          'Only affects official quota reset status, invite, and consume requests for this OpenAI OAuth account.',
        codexInviteResetUserAgent: 'Reset request User-Agent',
