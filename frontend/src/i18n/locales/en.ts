    ...
    settings: {
      ...
      features: {
        ...
        dailyCheckin: {
          ...
          description: 'Users can check in from the header after spending at least $1 today and receive a random integer USD credit reward.',
          rewardMin: 'Minimum Reward (USD)',
          rewardMax: 'Maximum Reward (USD)',
          rewardHint: 'Rewards are added directly to account balance, capped at 100 USD per sign-in. If the maximum is lower than the minimum, it will be saved as the minimum.',
        },
        riskControl: {
          title: 'Risk Control',
