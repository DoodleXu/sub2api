  ...
  admin: {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: 'When enabled, the hosted image tool is injected only when a request explicitly selects image_generation or directly continues an image turn. Plain text requests are left unchanged. Keep off unless the routed accounts support image generation.',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageToolDesc:
          'One policy for the image_generation tool on Codex /responses: bridge it only for explicit selections or direct image continuations, and control whether client-provided tools pass through. Account policy takes precedence over channel and global settings; standalone image-generation endpoints are unaffected.',
        ...
        codexImageToolEnabled: 'Enable explicit bridge',
        codexImageToolEnabledDesc: 'Inject the hosted image tool only when image_generation is explicitly selected or the request directly continues an image turn.',
        ...
        codexImageToolBadgeEnabled: 'Explicit bridge',
