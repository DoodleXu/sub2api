export default {
  ...
  admin: {
    ...
    operations: {
      ...
      paymentRevenue: 'Payment Revenue',
      ...
      marginDefinition: 'Contribution margin = actual charges - upstream account cost - check-in rewards. Payment revenue remains in its original currencies and is not mixed into USD charges.',
    ...
    settings: {
      ...
      emailBroadcast: {
        ...
        statusSummary: 'Status: {status}. Sent {sent}/{total}; skipped {skipped} (unsubscribed {unsubscribed}); failed {failed}.',
