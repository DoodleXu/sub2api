export default {
  ...
  home: {
    ...
    stableRunning: 'Stable for {days}d {hours}h {minutes}m {seconds}s',
  ...
  nav: {
    ...
    imageGenerationQueue: 'Image Queue',
    imageGenerationResults: 'Image Results',
    redeem: 'Redeem',
  ...
  keys: {
    ...
    groupLabel: 'Group',
    bindingLabel: 'Group / Subscription',
    selectGroup: 'Select a group',
    selectBinding: 'Select a group or subscription',
    ...
    groupRequired: 'Please select a group or subscription',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
  ...
  affiliate: {
    ...
    description: 'Invite new users to earn rebates on recharges only; subscriptions do not earn rebates',
    ...
    tips: {
      ...
      line2: 'Only invitee recharges earn {rate} rebate quota; subscriptions do not earn rebates.',
  ...
  redeem: {
    ...
    balanceAddedCheckin: 'Balance Added (Sign-in)',
  ...
  profile: {
    ...
    checkin: {
      calendarTitle: 'Monthly Check-in',
      calendarDescription: 'Check in after meeting the daily spend requirement to receive random credit.',
      checkedDays: 'Checked-in days',
      todayUsage: 'Today Spend',
      requiredUsage: 'Requirement',
      rewardRange: 'Reward Range',
      success: 'Checked in successfully. {amount} credit has been added.',
      successStreak: 'Checked in for {days} days in a row. Today reward is {multiplier}. {amount} credit has been added.',
      successCritSimple: 'Lucky critical! Today reward hit {critMultiplier}. {amount} credit has been added.',
      successCrit: 'Lucky critical! {days}-day streak, streak {streakMultiplier}, critical {critMultiplier}. {amount} credit has been added.',
      failed: 'Check-in failed',
      loadFailed: 'Failed to load check-in status',
      alreadyCheckedIn: 'Already checked in today',
      disabled: 'Daily check-in is not enabled',
      budgetExhausted: 'Check-in reward credit has been used up. Please try again later.',
      tooManyRequests: 'Too many requests. Please try again later.',
      usageNotEnough: 'Today spend is {current}. Check-in requires at least {required}.',
      readyTitle: 'Ready to check in. Random reward: {min}-{max} USD credit.',
      needUsageTitle: 'Today spend is {current}. Check in after reaching {required}.',
      checkedDayLabel: '{date} checked in',
      uncheckedDayLabel: '{date} not checked in',
      weekdays: {
        mon: 'Mon',
        tue: 'Tue',
        wed: 'Wed',
  ...
  admin: {
    imageGenerations: {
      ...
      noObjects: 'No async image results under this prefix.',
      loadObjectsFailed: 'Failed to read async image objects. Check ListBucket permissions.',
      queueEyebrow: 'Async task monitor',
      queueTitle: 'Image Queue',
      queueDescription: 'Monitor asynchronous image jobs, durations, and stop reasons in real time.',
      ...
      loadFailed: 'Failed to load the image queue. Please try again.'
    },
    // Dashboard
    dashboard: {
      ...
      perUsd: 'per USD',
      anthropicAverageCost: 'Anthropic Avg Cost',
    ...
    audit: {
      ...
      filters: {
        all: 'All', q: 'Keyword', qPlaceholder: 'Path / action / actor email', actorEmail: 'Actor Email',
        action: 'Action', clientIp: 'Client IP', method: 'Method', authMethod: 'Auth Method', result: 'Result',
        resultSuccess: 'Success', resultFailure: 'Failure', startTime: 'Start Time', endTime: 'End Time'
      },
      authMethods: { password: 'Password', passwordTotp: 'Password + TOTP', oauthTotp: 'OAuth + TOTP' },
      columns: { time: 'Time', actor: 'Actor', action: 'Action', method: 'Method', result: 'Result', clientIp: 'Client IP', detail: 'Detail' },
      detail: {
        title: 'Audit Log Detail', actorRole: 'Role', methodPath: 'Method / Path', latency: 'Latency', requestId: 'Request ID',
        credential: 'Credential (masked)', userAgent: 'User-Agent', requestBody: 'Request Body (redacted)', extra: 'Extra'
      },
      clearConfirm: {
        title: 'Clear All Audit Logs',
        message: 'This permanently deletes all audit logs and cannot be undone. The clear action itself is recorded. Continue?',
        totpTitle: 'Enter Two-Factor Code', totpHint: 'Clearing audit logs requires a fresh TOTP verification.',
        success: 'Cleared {count} audit log(s)', failed: 'Failed to clear audit logs'
      }
    },
    ...
    backup: {
      ...
      coreData: {
        title: 'Core Data Compatible Import',
        description: 'Migrate core runtime data into a new instance without full SQL restore.',
        scopeHint: 'Import scope: accounts, account credentials, account extra config, proxies, and account-to-proxy bindings. Users, groups, orders, logs, statistics, system settings, and backup records are not imported.',
        warning: 'Import creates new accounts; proxies are reused by protocol, host, port, username, and password. Import after initializing a new instance, then review account groups and scheduling state manually.',
        exportButton: 'Export Core Data',
        exportSuccess: 'Core data file exported',
        exportFailed: 'Failed to export core data',
        fileLabel: 'Core Data JSON File',
        noFile: 'Please choose a core data JSON file',
        importButton: 'Import Core Data',
        importing: 'Importing...',
        parseFailed: 'Failed to parse JSON file',
        importFailed: 'Failed to import core data',
        importSuccess: 'Import completed: {account_created} accounts, {proxy_created} new proxies, {proxy_reused} reused proxies.',
        importCompletedWithErrors: 'Import completed with errors: {account_failed} account failures, {proxy_failed} proxy failures.',
        resultTitle: 'Import Result',
        resultSummary: 'Created {account_created} accounts, failed {account_failed} accounts; created {proxy_created} proxies, reused {proxy_reused} proxies, failed {proxy_failed} proxies.'
      },
      columns: {
        status: 'Status',
        fileName: 'File Name',
    ...
    users: {
      ...
      typeCheckinBalance: 'Balance (Sign-in)',
      ...
      totalCheckinReward: 'Sign-in Total',
      roles: {
        admin: 'Admin',
        user: 'User'
      },
    ...
    groups: {
      ...
      subscription: {
        ...
        subscription: 'Subscription (Monthly Quota)',
        subscriptionMonthly: 'Subscription (Monthly Quota)',
        subscriptionWeekly: 'Subscription (Weekly Quota)',
        subscriptionDaily: 'Subscription (Daily Quota)',
    ...
    riskControl: {
      ...
      allowedHashCount: 'Hash allowlist size: {count}',
      allowedHashHint: 'The hash allowlist is persisted in the database and Redis is only a cache. Allowlisted hashes skip keyword, historical risk-hash, and upstream moderation checks, and are recorded as allow logs.',
      allowedHashPlaceholder: 'Paste a 64-character input hash to allow',
      allowedHashNotePlaceholder: 'Note (optional)',
      allowedHashSearchPlaceholder: 'Search allowlisted hashes',
      allowHash: 'Allow hash',
      allowHashShort: 'Allow',
      deleteAllowedHash: 'Remove allow',
      clearAllowedHashes: 'Clear allowlist',
      clearAllowedHashesConfirm: 'Clear all allowlisted hashes? This does not delete audit records, but removes all hash allow rules.',
      allowedHashAdded: 'Hash added to allowlist',
      allowedHashAlreadyExists: 'Hash is already allowlisted',
      allowedHashAddFailed: 'Failed to allow hash',
      allowedHashDeleted: 'Hash removed from allowlist',
      allowedHashNotFound: 'Allowlisted hash not found',
      allowedHashDeleteFailed: 'Failed to remove allowed hash',
      allowedHashListFailed: 'Failed to load hash allowlist',
      allowedHashesCleared: 'Cleared {count} allowlisted hashes',
      allowedHashesClearFailed: 'Failed to clear hash allowlist',
      allowedHashEmpty: 'No allowlisted hashes',
      allowedHashColumns: {
        hash: 'Hash',
        source: 'Source',
        note: 'Note / Input',
      ...
      inputDetailTitle: 'Input Detail',
      inputDetailFullTitle: 'Full Input Detail',
      inputDetailContent: 'User Input',
      inputDetailSummaryContent: 'Summary Content',
      ...
      userWhitelistHint: 'Whitelisted users skip content moderation, keyword blocks, hash blocks, and auto-ban counting.',
      userWhitelistSearch: 'Search username, email, or notes to add users',
      userWhitelistNoResults: 'No matching users',
      userWhitelistCount: '{count} whitelisted UIDs',
      forcedWhitelist: 'Always kept',
      removeWhitelistUser: 'Remove from whitelist',
      userPolicy: {
        title: 'User Handling Policies',
        hint: 'Override hit handling for specific users: blocking response, error code, notification, and account disablement. Whitelisted users do not trigger these policies.',
        search: 'Search UID, email, or note',
        create: 'New Policy',
        createTitle: 'New User Handling Policy',
        editTitle: 'Edit User Handling Policy',
        empty: 'No user handling policies',
        loadFailed: 'Failed to load user policies',
        saved: 'User policy saved',
        saveFailed: 'Failed to save user policy',
        deleted: 'User policy deleted',
        deleteFailed: 'Failed to delete user policy',
        deleteConfirm: 'Delete this user handling policy?',
        enabled: 'Enabled',
        disabled: 'Disabled',
        inheritGlobal: 'Global default',
        thresholdSummary: '{count} hits in {hours} hours to disable',
        columns: {
          user: 'User',
          action: 'Action',
          response: 'Response',
        ...
        actions: {
          ...
          blockNotify: 'Block and notify',
          blockNotifyDisable: 'Block, notify, and disable',
        },
        form: {
          user: 'Target user',
          userSearch: 'Search username, email, or notes',
          noUsers: 'No eligible users',
          action: 'Action',
          enabled: 'Enable policy',
          enabledHint: 'Keep the policy stored but do not apply it when disabled.',
          blockStatus: 'HTTP status (0 = global)',
          errorCode: 'Error code',
          blockMessage: 'Block message',
          inheritMessage: 'Leave empty to inherit global message',
          applyToHashBlock: 'Apply to hash blocks',
          applyToHashBlockHint: 'By default hash fast-blocks only record logs; enabling this applies user-policy side effects too.',
          note: 'Note',
        },
      },
    ...
    subscriptions: {
      ...
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      resetWeeklyQuota: 'Reset Weekly Quota',
      resetWeeklyQuotaTitle: 'Reset Weekly Usage Quota',
      resetWeeklyQuotaConfirm: "Reset the daily and weekly usage quota for '{user}'? Monthly usage will not be reset.",
      weeklyQuotaResetSuccess: 'Weekly quota reset successfully',
      failedToResetWeeklyQuota: 'Failed to reset weekly quota',
      resetAllWeeklyQuota: 'Reset All Weekly Quota',
      resetAllWeeklyQuotaTitle: 'Reset All Subscription Weekly Quota',
      resetAllWeeklyQuotaConfirm: 'Reset daily and weekly usage quota for all active subscriptions? Monthly usage will not be reset.',
      resetAllWeeklyQuotaDryRunSummary: 'Dry-run preview: {count} active subscription(s) will be affected',
      allWeeklyQuotaResetSuccess: 'Reset weekly quota for {count} subscription(s), {failed} failed, run {runId}',
      failedToPreviewResetAllWeeklyQuota: 'Failed to preview all weekly quota reset',
      failedToResetAllWeeklyQuota: 'Failed to reset all weekly quota',
    ...
    accounts: {
      ...
      listPendingSyncFailed: 'Failed to sync the list automatically. Please try again later.',
      ...
      unarchiveSuccess: 'Account unarchived successfully',
      ...
      bulkArchiveConfirm: 'Archive the selected {count} account(s)? Historical cost and usage will be kept.',
      ...
      totalCostCnyHint: 'Total CNY spent on this account, used to calculate average cost per USD',
      addCostCny: 'Add Cost (CNY)',
      addCostCnyHint: 'For API Key accounts, this value is added to the accumulated CNY cost on save',
      expiresAt: 'Expires At',
    ...
    operations: {
      title: 'Operations',
      description: 'Manage check-in campaigns, reward rules, and operation data',
      overview: 'Overview',
      businessInsights: 'Business Insights',
      checkinAnalysis: 'Check-in Analysis',
      records: 'Check-in Records',
      rules: 'Reward Rules',
      last7Days: 'Last 7 days',
      last30Days: 'Last 30 days',
      last90Days: 'Last 90 days',
      last370Days: 'Last 370 days',
      applyRange: 'Apply Range',
      customDateFrom: 'Custom start date',
      customDateTo: 'Custom end date',
      invalidDateRange: 'Select a valid start and end date',
      apiDau: 'API DAU',
      apiDauHint: 'Unique API users on the last day in range',
      newUsers: 'New Users',
      requestUsers: 'Request Users',
      requests: 'Requests',
      actualCost: 'Actual Cost',
      activitySummary: 'Activity Summary',
      apiActivityTrend: 'API Activity Trend',
      apiActivityTrendHint: 'Daily API active users and new users for real usage growth.',
      checkinTrend: 'Check-in Trend',
      checkinTrendHint: 'Bars show check-in users; the line shows conversion from qualified users.',
      noTrendData: 'No trend data',
      qualifiedUsers: 'Qualified Users',
      checkinUsers: 'Check-in Users',
      streakUsers: 'Streak Users',
      checkinRate: 'Check-in Rate',
      checkinFunnel: 'Check-in Funnel',
      rewardBudget: 'Reward Budget',
      rewardDistribution: 'Reward Distribution',
      ruleEffect: 'Rule Effect',
      fallbackRate: 'Fallback Rate',
      critRate: 'Critical Rate',
      streakUserRate: 'Streak Share',
      projectedBudgetDays: 'Projected Budget',
      daysValue: '{count} days',
      checkinsValue: 'About {count} check-ins',
      estimatedRemainingCheckins: 'Estimated Check-ins Remaining Today',
      unlimited: 'Unlimited',
      dataAsOf: 'Data as of',
      ...
      dataQuality: {
        ...
        partial: 'The requested range predates raw usage coverage and may be incomplete',
        empty: 'No usage data in the current range',
        unknown: 'Data coverage is currently unavailable',
      },
      vsPreviousPeriod: 'vs previous period {value}',
      noChange: 'No change vs previous period',
      newFromZero: 'Previous period was zero',
      exportData: 'Data Export',
      exportOverview: 'Export Activity',
      exportOverviewHint: 'Export DAU, new users, requests, and actual cost for the selected date range.',
      exportSummary: 'Export Summary',
      exportRecords: 'Export Records',
      exporting: 'Exporting...',
      exportSuccess: 'Operations data exported',
      ...
      save: 'Save Rules',
      saving: 'Saving...',
      saved: 'Check-in rules saved',
      loadFailed: 'Failed to load operation data',
      overviewLoadFailed: 'Failed to load the operations overview; displayed values may be outdated',
      analyticsLoadFailed: 'Failed to load check-in analytics; displayed values may be outdated',
      recordsLoadFailed: 'Failed to load check-in records',
      businessLoadFailed: 'Failed to load business insights; displayed values may be outdated',
      businessDataUnavailable: 'Pre-aggregated data does not cover this range yet, so charges, costs, and contribution margin are unavailable.',
      businessDataPartial: 'This range includes data still being aggregated. Business metrics are shown through the latest completed aggregate.',
      groupDetailsRangeLimited: 'Group details are available for ranges up to 31 days',
      saveFailed: 'Failed to save check-in rules',
      filters: 'Filters',
      userSearch: 'User ID / email / username',
      dateFrom: 'Start Date',
      dateTo: 'End Date',
      rewardMin: 'Min Reward',
      rewardMax: 'Max Reward',
      critHit: 'Critical Status',
      all: 'All',
      critOnly: 'Critical only',
      nonCritOnly: 'Non-critical only',
      minStreakDays: 'Min Streak Days',
      user: 'User',
      date: 'Date',
      ...
      requiredUsage: 'Required Spend',
      usageScope: 'Usage Scope',
      usageScopeActual: 'All actual spend',
      usageScopeBalance: 'Balance spend only',
      userMonthlyLimit: 'User Monthly Limit',
      dailyBudget: 'Daily Budget',
      monthlyBudget: 'Monthly Budget',
      budgetFallbackReward: 'Budget Fallback Reward',
      budgetFallbackMessage: 'Budget Fallback Message',
      budgetFallbackHint: 'When the daily budget cannot cover the normal minimum reward, check-in remains available and this fixed fallback reward is granted.',
      rewardTiers: 'Reward Probability Tiers',
      addTier: 'Add Tier',
      minReward: 'Min Reward',
      maxReward: 'Max Reward',
      probability: 'Probability %',
      probabilityTotal: 'Probability Total',
      streakEnabled: 'Enable Streak Multiplier',
      streakScope: 'Streak Scope',
      streakCrossMonth: 'Cross-month',
      streakMonthly: 'Monthly reset',
      streakRules: 'Streak Multipliers',
      ...
      critMaxRewardHint: 'Rewards after streak above this amount do not enter critical draw. 0 means unlimited.',
      delete: 'Delete',
      totalUsers: 'Total Users',
      todayNewUsers: 'New Users Today',
      todayActiveUsers: 'Active Users Today',
      periodRequestUsers: 'Request Users in Range',
      d1Retention: 'D1 API Retention',
      d7Retention: 'D7 API Retention',
      d30Retention: 'D30 API Retention',
      averageActiveDays: 'Average Active Days',
      revenueAndMargin: 'Revenue and Contribution Margin',
      paymentRevenue: 'Online Payment Revenue',
      adminRechargeRevenue: 'Manual Admin Recharges',
      adminRechargeCredits: 'Manual Balance Credits',
      totalRevenue: 'Total Revenue',
      paidOrders: 'Paid Orders',
      actualCharges: 'Actual Charges',
      upstreamCost: 'Upstream Account Cost',
      accountCostUsdBasis: 'Account Billing Cost',
      rewardCost: 'Check-in Reward Cost',
      contributionMargin: 'Contribution Margin / Rate',
      marginDefinition: 'Online payments remain separated by ISO currency. Manual balance credits, actual charges, account billing cost, check-in rewards, and contribution margin use USD balance units. Real upstream CNY cost is shown separately and is not mixed into the USD margin.',
      productUsage: 'Product Usage',
      periodRequests: 'Requests in Range',
      periodTokens: 'Tokens in Range',
      averageChargePerUser: 'Average Charge per Request User',
      topModels: 'Top Models (Requests / Actual Charges)',
      topGroups: 'Top Groups (Requests / Actual Charges)',
      noBusinessData: 'No business data',
    },
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreDisabledApiKeyErrors: 'Ignore disabled API key errors',
        ignoreDisabledApiKeyErrorsHint: 'When enabled, disabled API key errors (API_KEY_DISABLED) will not be written to the error log.',
    ...
    settings: {
      ...
      features: {
        ...
        dailyCheckin: {
          ...
          description: 'Users can claim a random integer USD credit reward after reaching the configured daily spend requirement.',
          enabled: 'Enable Daily Check-in',
          enabledHint: 'When disabled, the user check-in button and profile calendar are hidden, and the backend check-in endpoint rejects rewards.',
          todayCheckins: 'Today Check-ins',
          todayReward: 'Today Rewards',
          monthReward: 'Monthly Rewards',
          averageReward: 'Average Reward',
          requiredUsage: 'Spend Requirement (USD)',
          usageScope: 'Eligible Spend Scope',
          usageScopeActualCost: 'All actual spend',
          usageScopeBalanceOnly: 'Balance spend only',
          rewardMin: 'Minimum Reward (USD)',
          rewardMax: 'Maximum Reward (USD)',
          dailyBudget: 'Daily Budget (USD)',
          monthlyBudget: 'Monthly Budget (USD)',
          userMonthlyLimit: 'User Monthly Cap (USD)',
          dailyRemaining: 'Daily budget/remaining',
          monthlyRemaining: 'Monthly budget/remaining',
          monthUsers: 'Monthly Users',
          unlimited: 'Unlimited',
          statsLoadFailed: 'Failed to load check-in stats. Values are hidden until refresh succeeds.',
          rewardHint: '0 means unlimited. Rewards are added directly to account balance, capped at 100 USD per sign-in. If the maximum is lower than the minimum, it will be saved as the minimum.',
        },
        riskControl: {
          title: 'Risk Control',
      ...
      site: {
        ...
        siteLaunchAt: 'Stable Since',
        siteLaunchAtHint: 'Shown on the home page as site uptime. Leave empty to hide it. Saved as an absolute time with timezone.',
      ...
      payment: {
        ...
        field_feeRate: 'Custom fee rate',
        field_feeMin: 'Minimum fee',
        ...
        field_stripeFeeRateHint: 'Leave both custom fee fields empty to inherit the global recharge fee. To override Stripe fees, fill both the rate and minimum fee.',
        field_stripeFeeMinHint: 'Leave both custom fee fields empty to inherit the global recharge fee. When overriding Stripe fees, this minimum fee is added to amount * rate.',
      ...
      notifications: {
        ...
        description: 'Send channel monitor failure and recovery notices through Email, Bark, and Telegram Bot.',
        email: 'Email',
        emailHint: 'Reuses the editable notification email templates.',
        bark: 'Bark',
        barkHint: 'Push notifications to iOS/macOS clients through Bark.',
        telegram: 'Telegram Bot',
        telegramHint: 'Send messages with the Telegram Bot API.',
        recipients: 'Email recipients',
        recipientsPlaceholder: "admin{'@'}example.com\nops{'@'}example.com",
        barkServerUrl: 'Bark server URL',
        barkDeviceKeys: 'Bark device keys',
        barkDeviceKeysPlaceholder: 'One device key per line',
        barkLevel: 'Bark level',
        barkTitleTemplate: 'Bark push title',
        barkTitleTemplatePlaceholder: 'Sub2API channel monitor: {monitor_name} {new_status}',
        barkBodyTemplate: 'Bark push body',
        barkBodyTemplatePlaceholder: 'Monitor: {monitor_name}\nModel: {model}\nStatus: {old_status} -> {new_status}',
        barkTemplateHint: 'Supports variables such as {monitor_name}, {provider}, {group_name}, {model}, {old_status}, {new_status}, {latency_ms}, {message}, and {triggered_at}.',
        telegramBotToken: 'Bot token',
        telegramBotTokenHint: 'Created from BotFather. Stored encrypted on the backend.',
        telegramChatIds: 'Chat IDs',
        telegramChatIdsPlaceholder: 'One chat ID per line',
        onePerLineHint: 'One per line; comma-separated values are also accepted.',
        secretConfiguredPlaceholder: 'Configured. Leave empty to keep current value.',
        secretConfiguredHint: 'A secret is already configured. Leave empty to keep it unchanged.',
        clearBarkDeviceKeys: 'Clear saved Bark device keys',
        clearTelegramBotToken: 'Clear saved bot token',
        quietHours: 'Quiet hours',
        quietHoursHint: 'Email, Bark, and Telegram notifications are silently dropped during this window and will not be sent later.',
        ...
        loadFailed: 'Failed to load notification settings. Refresh before saving to avoid overwriting existing configuration.',
        saveFailed: 'Failed to save notification settings',
        testTransport: 'Test saved {transport}',
        testSavedHint: 'Save notification settings before testing. Tests use the saved backend configuration.',
        ...
        events: {
          failed: 'Channel monitor failure',
          recovered: 'Channel monitor recovery',
        },
        barkLevels: {
          active: 'Active',
      ...
      emailBroadcast: {
        ...
        pageDescription: 'Start broadcasts and manage background email delivery tasks.',
        composeTitle: 'Compose broadcast',
        description: 'Send important email notices to a selected user range. The body is wrapped by the admin email notification template and sent in the background at low RPM.',
        taskTitle: 'Broadcast tasks',
        taskDescription: 'Track delivery status, stop active tasks, continue interrupted tasks, and resend failed recipients.',
        task: 'Task',
        progress: 'Progress',
        startedAt: 'Started',
        updatedAt: 'Updated',
        refreshTasks: 'Refresh tasks',
        noTasks: 'No email broadcast tasks yet.',
        activeBatch: 'Active batch: {batch}',
        scope: 'User range',
        locale: 'Email locale',
        rpm: 'Send RPM',
        rateHint: 'About 1 email every {seconds}s',
        messageTitle: 'Notice title',
        messageTitlePlaceholder: 'Example: Scheduled maintenance notice',
        messageHtml: 'Notice HTML body',
        messageHtmlPlaceholder: '<p>Enter the notice content to send to users.</p>',
        actionLabel: 'Button label (optional)',
        actionLabelPlaceholder: 'View details',
        actionUrl: 'Button URL (optional)',
        customUserIds: 'Specific user IDs',
        customUserIdsPlaceholder: 'One user ID per line; comma-separated values are also accepted',
        customEmails: 'Extra emails',
        customEmailsPlaceholder: "user{'@'}example.com\nanother{'@'}example.com",
        noDraft: 'No saved draft.',
        draftSavedAt: 'Draft saved: {time}',
        loadDraft: 'Load draft',
        saveDraft: 'Save draft',
        clearDraft: 'Clear draft',
        draftSaved: 'Broadcast draft saved',
        draftCleared: 'Broadcast draft cleared',
        draftLoadFailed: 'Failed to load broadcast draft',
        draftSaveFailed: 'Failed to save broadcast draft',
        draftClearFailed: 'Failed to clear broadcast draft',
        send: 'Start Broadcast',
        sending: 'Submitting...',
        required: 'Enter a notice title and body.',
        customRequired: 'Custom range requires at least one user ID or email.',
        started: 'Email broadcast started: {count} recipients, batch {batch}',
        failed: 'Failed to start email broadcast',
        statusFailed: 'Failed to refresh email broadcast status',
        operationFailed: 'Email broadcast operation failed',
        cancel: 'Stop',
        cancelRequested: 'Stop requested',
        resume: 'Continue',
        resendFailed: 'Resend failed',
        resendUncertain: 'Retry uncertain',
        details: 'Details',
        recipientDetails: 'Recipient details ({count} total)',
        recipientLoadFailed: 'Failed to load recipient details',
        preflightFailed: 'Broadcast preflight failed',
        resumed: 'Email broadcast resumed: {count} recipients, batch {batch}',
        lastResult: 'Batch {batch} started for {count} recipients at RPM {rpm}. Estimated duration: {seconds}s.',
        statusSummary: 'Status: {status}. Sent {sent}/{total}; skipped {skipped} (unsubscribed {unsubscribed}); failed {failed}; uncertain {uncertain}.',
        confirmTitle: 'Confirm Email Broadcast',
        confirmMessage: 'This will immediately start sending real emails. Confirm the range and rate before continuing.',
        confirmSummary: 'Range: {scope}; RPM: {rpm}; about 1 email every {seconds}s.',
        confirmPreflightSummary: 'Range: {scope}; valid {valid}, unsubscribed {unsubscribed}, invalid {invalid}; RPM {rpm}; estimated {duration}.',
        durationSeconds: '{count}s',
        durationMinutes: 'about {count} min',
        durationHours: 'about {count} hr',
        confirmSend: 'Confirm Send',
        confirmPhraseLabel: 'Bulk ranges require typing SEND before sending',
        confirmPhraseRequired: 'Type {phrase} before confirming the broadcast.',
        scopes: {
          activeUsers: 'Active regular users',
          allUsers: 'All regular users',
          admins: 'Active admins',
          custom: 'Custom users / emails',
        },
        locales: {
          auto: 'Recipient preference',
          zh: 'Chinese',
          en: 'English',
        },
        statuses: {
  ...
  payment: {
    ...
    upgrade: {
      ...
      noEligibleSubscriptions: 'No eligible subscription credit is available. Only active subscriptions from a valid paid order on the same platform can be credited.',
      noEligibleSubscriptionsWithActive: 'Your active subscriptions are not eligible for credit. Make sure the old subscription and the new plan belong to the same platform and the old subscription came from a valid paid order.',
      retry: 'Retry',
    ...
    admin: {
      ...
      deductSubscription: 'Cancel active subscription entitlement',
      deductSubscriptionHint: 'Deduct the corresponding validity from the user subscription',
      subscriptionDaysToDeduct: 'Days to Deduct',
      subscriptionDaysAutoHint: 'Suggested {days} day(s) from the refund amount; you can adjust it manually',
      subscriptionRemainingHint: 'Calculated from {days} remaining subscription day(s); you can adjust it manually',
      noSubscriptionDeduction: 'Will NOT deduct user subscription entitlement',
