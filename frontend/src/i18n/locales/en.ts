export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      allowedHashHint: 'After manual review, add an input hash to the global allowlist. Allowlisted hashes skip keyword, historical risk-hash, and upstream moderation checks, and are recorded as allow logs.',
