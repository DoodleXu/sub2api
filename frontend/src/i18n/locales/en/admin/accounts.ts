export default {
    accounts: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate comes from the upstream site. Native Sub2API upstreams declare it through API key introspection; New API compatibility uses the effective group rate from the latest usage log. Sub2API cannot independently verify the final charge. Check bills, balance changes, and actual usage.',
        autoProbeSettings: 'Automatic rate probing',
        intervalMinutes: 'Interval (minutes)',
        settingsSaved: 'Automatic probe settings saved',
        settingsFailed: 'Failed to save automatic probe settings',
        ...
        failed: 'Failed',
        noBillingSample: 'No billing sample yet',
        notProbed: 'Not probed',
        newAPISource: 'Source: latest New API usage log (observed)',
        observedGroupRate: 'Latest billed group: {group}, rate {value}x',
        observedRate: 'Observed rate: {value}x',
        sampleAt: 'Sample time: {value}',
