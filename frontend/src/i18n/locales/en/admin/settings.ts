export default {
    settings: {
      ...
      payment: {
        ...
        rechargeGiftHint: 'Set gift percentages by recharge threshold; the highest matching gift percentage applies',
        rechargeGiftTiers: 'Gift Tiers',
        rechargeGiftAddTier: 'Add Tier',
        rechargeGiftThreshold: 'Recharge Threshold',
        rechargeGiftPercent: 'Gift Percentage',
        rechargeGiftDelete: 'Delete',
        rechargeGiftEmpty: 'No tiers configured. Add a tier to enable gifts.',
        ...
        field_providerFeeRateHint: 'Fee rate for this provider. Leave blank to inherit the global recharge fee rate; enter 0 to waive the fee for this provider.',
      ...
      openaiExperimentalScheduler: {
        ...
        lowRatePriorityDescription: 'When enabled, accounts with lower billing rates are preferred. Accounts that do not support rate probing use their cost per USD for comparison. If values are equal, account priority, current load, and other scheduling factors are considered. This switch is ignored when the experimental scheduler is enabled.',
        ...
        usdToCnyRateTitle: 'Scheduler USD to CNY rate',
        usdToCnyRateDescription: 'Converts CNY cost per USD into the same USD-cost basis as upstream billing multipliers. Enter CNY per 1 USD, for example 7.2.',
