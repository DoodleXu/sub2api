export default {
  common: {
    ...
    routeLoadErrorTitle: 'Page resources failed to load',
    routeLoadErrorDescription: 'The page may have been updated or cached inconsistently. Reload it, or return to the dashboard if the problem continues.',
