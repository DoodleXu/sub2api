...
func registerContentModerationRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	risk := admin.Group("/risk-control")
	{
		...
		risk.GET("/user-policies", h.Admin.ContentModeration.ListUserPolicies)
		risk.POST("/user-policies", h.Admin.ContentModeration.CreateUserPolicy)
		risk.PUT("/user-policies/:policy_id", h.Admin.ContentModeration.UpdateUserPolicy)
		risk.DELETE("/user-policies/:policy_id", h.Admin.ContentModeration.DeleteUserPolicy)
		risk.POST("/users/:user_id/unban", h.Admin.ContentModeration.UnbanUser)
		risk.GET("/hashes/allow", h.Admin.ContentModeration.ListAllowedHashes)
		risk.POST("/hashes/allow", h.Admin.ContentModeration.AllowHash)
		risk.DELETE("/hashes/allow/all", h.Admin.ContentModeration.ClearAllowedHashes)
		risk.DELETE("/hashes/allow", h.Admin.ContentModeration.DeleteAllowedHash)
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/cost-summary", h.Admin.Dashboard.GetCostSummary)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/daily-checkin/stats", h.Admin.Setting.GetDailyCheckinStats)
		...
		adminSettings.DELETE("/email-broadcasts/draft", gin.HandlerFunc(stepUpAuth), h.Admin.Setting.DeleteEmailBroadcastDraft)
