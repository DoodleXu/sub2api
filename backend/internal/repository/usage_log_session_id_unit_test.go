...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 61, "arg-type table must include session_id and succeeded")
	...
	// created_at is last and succeeded precedes it; session_id is before both.
