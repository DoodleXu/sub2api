...
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 64, "arg-type table must include upstream_request_id, session_id, native_compaction_v2 and succeeded")
	...
	// created_at is last, succeeded/native_compaction_v2 follow session_id.
...
func TestUsageLogInsertQueries_IncludeSessionID(t *testing.T) {
	...
	require.GreaterOrEqual(t, strings.Count(batchQuery, "image_input_tokens"), 3)
	require.GreaterOrEqual(t, strings.Count(batchQuery, "image_input_cost"), 3)
	...
	require.GreaterOrEqual(t, strings.Count(bestEffortQuery, "image_input_tokens"), 3)
	require.GreaterOrEqual(t, strings.Count(bestEffortQuery, "image_input_cost"), 3)
