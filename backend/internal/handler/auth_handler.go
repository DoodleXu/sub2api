...
func (h *AuthHandler) respondWithTokenPair(c *gin.Context, user *service.User, authMethod string) {
	respondWithTokenPair(c, h.authService, user, authMethod)
}

func respondWithTokenPair(c *gin.Context, authService *service.AuthService, user *service.User, authMethod string) {
