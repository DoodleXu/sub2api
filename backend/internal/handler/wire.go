...
func ProvideOpenAIGatewayHandler(
	...
	h.SetImageStorageSettingService(imageStorageSettings)
	return h
}
...
func ProvideAdminSettingHandler(settingService *service.SettingService, emailService *service.EmailService, turnstileService *service.TurnstileService, aliyunCaptchaService *service.AliyunCaptchaService, opsService *service.OpsService, paymentConfigService *service.PaymentConfigService, paymentService *service.PaymentService, userAttributeService *service.UserAttributeService, dailyCheckinService *service.DailyCheckinService, notificationEmailService *service.NotificationEmailService, notificationService *service.NotificationService, totpService *service.TotpService, userService *service.UserService) *admin.SettingHandler {
	h := admin.NewSettingHandler(settingService, emailService, turnstileService, opsService, paymentConfigService, paymentService, userAttributeService, dailyCheckinService)
	h.SetNotificationEmailService(notificationEmailService)
	h.SetNotificationService(notificationService)
