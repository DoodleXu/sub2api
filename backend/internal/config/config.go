...
func setDefaults() {
	...
	viper.SetDefault("dashboard_cache.stats_fresh_ttl_seconds", 120)
	viper.SetDefault("dashboard_cache.stats_ttl_seconds", 1800)
	...
	// UsageLogsDays remains the aggregation lookback horizon. Cost aggregation
	// never uses this setting to delete raw usage records.
	...
	viper.SetDefault("gateway.max_line_size", 128*1024*1024)
