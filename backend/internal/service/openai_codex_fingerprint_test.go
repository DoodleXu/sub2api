...
func TestOpenAIGatewayForwardAppliesSharedCodexFingerprintToBodyAndHeaders(t *testing.T) {
	...
	convergedInstall := resolveConvergedInstallationID(account, testCodexFingerprintSeed)
	convergedSession := resolveConvergedSessionID(testCodexFingerprintSeed)
	convergedThread := resolveConvergedThreadID(testCodexFingerprintSeed, "client-session-fingerprint")
