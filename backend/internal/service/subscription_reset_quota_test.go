...
func (r *resetQuotaUserSubRepoStub) ResetDailyUsage(_ context.Context, id int64, _ *time.Time, windowStart time.Time) error {
...
func (r *resetQuotaUserSubRepoStub) ResetWeeklyUsage(_ context.Context, id int64, _ *time.Time, _ time.Time) error {
	r.resetWeeklyCalled = true
	r.resetWeeklyIDs = append(r.resetWeeklyIDs, id)
	return r.resetWeeklyErr
}

func (r *resetQuotaUserSubRepoStub) ResetMonthlyUsage(_ context.Context, id int64, _ *time.Time, _ time.Time) error {
