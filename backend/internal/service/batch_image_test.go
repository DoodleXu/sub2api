...
func TestCanTransitionBatchImageJob(t *testing.T) {
	tests := []struct {
		...
		{name: "failed_to_output_deleted_invalid", from: BatchImageJobStatusFailed, to: BatchImageJobStatusOutputDeleted, want: false},
		{name: "cancelled_to_output_deleted_invalid", from: BatchImageJobStatusCancelled, to: BatchImageJobStatusOutputDeleted, want: false},
