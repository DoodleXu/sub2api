...
func TestCalculateCreateOrderPayAmountForSubscriptionConvertsCNYPriceWhenRateConfigured(t *testing.T) {
	...
	amountStr, amount, _, err := calculateCreateOrderPayAmountForOrderType(9.99, paymentFeeConfig{}, "CNY", payment.OrderTypeSubscription, 7.15)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCalculateCreateOrderPayAmountForSubscriptionAppliesFeeAfterCNYConversion(t *testing.T) {
	...
	amountStr, amount, _, err := calculateCreateOrderPayAmountForOrderType(9.99, paymentFeeConfig{Rate: 2.5}, "CNY", payment.OrderTypeSubscription, 7.15)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCalculateCreateOrderPayAmountForSubscriptionKeepsNonCNYPrice(t *testing.T) {
	...
	amountStr, amount, _, err := calculateCreateOrderPayAmountForOrderType(9.99, paymentFeeConfig{}, "USD", payment.OrderTypeSubscription, 7.15)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCalculateCreateOrderPayAmountForSubscriptionKeepsDirectPriceWhenRateDisabled(t *testing.T) {
	...
	amountStr, amount, _, err := calculateCreateOrderPayAmountForOrderType(9.99, paymentFeeConfig{}, "CNY", payment.OrderTypeSubscription, 0)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if amountStr != "9.99" || amount != 9.99 {
...
func TestCalculateCreateOrderPayAmountForBalanceIgnoresSubscriptionRate(t *testing.T) {
	...
	amountStr, amount, _, err := calculateCreateOrderPayAmountForOrderType(50, paymentFeeConfig{}, "CNY", payment.OrderTypeBalance, 7.15)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
