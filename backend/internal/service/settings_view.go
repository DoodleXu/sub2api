...
type SystemSettings struct {
	...
	DailyCheckinRewardTiers         []DailyCheckinRewardTier       `json:"daily_checkin_reward_tiers"`
	...
	DailyCheckinStreakMultipliers   []DailyCheckinStreakMultiplier `json:"daily_checkin_streak_multipliers"`
	...
	OpenAISchedulingUSDToCNYRate                           float64
