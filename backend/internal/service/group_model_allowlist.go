...
// CustomModelsListEnabled is the compatibility capability used by legacy
// handlers; model allowlist is now the canonical implementation.
func (g *Group) CustomModelsListEnabled() bool { return g != nil && g.ModelAllowlist.Enabled }
