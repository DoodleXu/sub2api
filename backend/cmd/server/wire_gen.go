...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelMonitorService := service.ProvideChannelMonitorService(channelMonitorRepository, secretEncryptor, notificationService)
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, opsService, paymentConfigService, paymentService, userAttributeService, dailyCheckinService, notificationEmailService, notificationService, totpService, userService)
	...
	imageGenerationArchiveRepository := repository.NewImageGenerationArchiveRepository(db)
	imageGenerationArchiveService := service.NewImageGenerationArchiveService(imageGenerationArchiveRepository, settingRepository, apiKeyRepository, configConfig)
	imageGenerationHandler := admin.NewImageGenerationHandler(imageGenerationArchiveService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, imageGenerationHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, imageGenerationArchiveService, opsService, grokQuotaService, configConfig, coordinator)
