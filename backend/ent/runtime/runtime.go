...
func init() {
	...
	// accountDescTotalCostCny is the schema descriptor for total_cost_cny field.
	accountDescTotalCostCny := accountFields[12].Descriptor()
	// account.DefaultTotalCostCny holds the default value on creation for the total_cost_cny field.
	account.DefaultTotalCostCny = accountDescTotalCostCny.Default.(float64)
	...
	// paymentorderDescUpgradeClaimActive is the schema descriptor for upgrade_claim_active field.
	paymentorderDescUpgradeClaimActive := paymentorderFields[19].Descriptor()
	// paymentorder.DefaultUpgradeClaimActive holds the default value on creation for the upgrade_claim_active field.
	paymentorder.DefaultUpgradeClaimActive = paymentorderDescUpgradeClaimActive.Default.(bool)
	// paymentorderDescUpgradeCreditAmount is the schema descriptor for upgrade_credit_amount field.
	paymentorderDescUpgradeCreditAmount := paymentorderFields[21].Descriptor()
	// paymentorder.DefaultUpgradeCreditAmount holds the default value on creation for the upgrade_credit_amount field.
	paymentorder.DefaultUpgradeCreditAmount = paymentorderDescUpgradeCreditAmount.Default.(float64)
